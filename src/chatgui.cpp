...
bool ChatBotApp::OnInit()
{
    ...
    ChatBotFrame *chatBotFrame = new ChatBotFrame(wxT("Udacity Memory ChatBot"));
...
ChatBotPanelDialog::~ChatBotPanelDialog()
{
    //// STUDENT CODE
    ////
    std::cout << "ChatBotPanelDial Destructor" << std::endl;
...
{
    std::cout << "create new ChatBotPanelDialgItem" << std::endl;
    ...
    this->SetBackgroundColour((isFromUser == true ? wxT("RED") : wxT("BLUE")));
}
